...
public class BaseProperties
{
  ...
  public boolean readProperties()
  {
    ...
    if (this.fileExists())
    {
      lbInput = Util.binaryFileToBytes(this.fcFullName);
    }
    ...
    {
      final SecretKeySpec loKey = new SecretKeySpec(Util.getKeyBytes(this.fcKey, BaseProperties.CRYPTO_KEY_LENGTH), BaseProperties.CRYPTO_PROVIDER_BASE);
      try
      {
  ...
  public boolean writeProperties()
  {
    ...
    if (this.fcKey == null)
    {
      try
      {
        Util.bytesToBinaryFile(lcString.getBytes("UTF8"), this.fcFullName);
      }
    ...
    else
    {
      try
      {
        ...
        Util.bytesToBinaryFile(loCipher.doFinal(lbOutput), this.fcFullName);
      }
